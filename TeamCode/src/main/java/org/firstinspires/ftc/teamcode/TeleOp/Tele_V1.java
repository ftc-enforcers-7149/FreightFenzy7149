...
public class Tele_V1 extends TeleOp_Base {
    ...
    public void loop() {
        ...
        if (gamepad1.dpad_up) turningIntake.setWristPosCenter();
        if (gamepad1.dpad_left) turningIntake.setWristPosLeft();
        if (gamepad1.dpad_right) turningIntake.setWristPosRight();
