...
@Config
public abstract class Auto_Base_Correction extends LinearOpMode {
    ...
    public void driveTo(double destX, double destY, double destH) {
        ...
        CrashCorrection c = new CrashCorrection(drive, gyro, new Pose2d(destX, destY, destH));
        ...
        while (opModeIsActive() &&
            ...
            drive.setWeightedDrivePower(c.correct(new Pose2d(xPower, yPower, hPower)));
