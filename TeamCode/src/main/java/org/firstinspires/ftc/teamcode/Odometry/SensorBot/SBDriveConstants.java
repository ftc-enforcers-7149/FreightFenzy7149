...
public class SBDriveConstants {
     ...
     */
    public static double WHEEL_RADIUS = 1.96850394; //Prob should be 1.88976; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 12.65;
     ...
     * Resulting in 35.86850580383074 in/s.
