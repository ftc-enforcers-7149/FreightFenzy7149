...
@Config
public class SBMecanumDrive extends MecanumDrive {
    ...
    public TrajectoryVelocityConstraint slowVelConstraint;
    public TrajectoryAccelerationConstraint slowAccelConstraint;

    private LinkedList<Pose2d> poseHistory;

    public DcMotorEx leftFront, leftRear, rightRear, rightFront;
    private List<DcMotorEx> motors;
    public SBLocalizer locale;
    ...
    public SBMecanumDrive(HardwareMap hardwareMap, BulkRead bReadCH, BulkRead bReadEH) {
        ...
        slowVelConstraint = new MinVelocityConstraint(Arrays.asList(
                new AngularVelocityConstraint(MAX_ANG_VEL * 0.75),
                new MecanumVelocityConstraint(MAX_VEL / 2, TRACK_WIDTH)
        ));

        accelConstraint = new ProfileAccelerationConstraint(MAX_ACCEL);
        slowAccelConstraint = new ProfileAccelerationConstraint(MAX_ACCEL * 0.75);
        ...
        //Set the localizer
        locale = new SBLocalizer(hardwareMap, bReadCH, bReadEH);
        setLocalizer(locale);
    }
    ...
    public void turnSlowAsync(double angle) {
        double heading = getPoseEstimate().getHeading();
    ...
    public void turnSlow(double angle) {
        turnSlowAsync(angle);
        waitForIdle();
    }
